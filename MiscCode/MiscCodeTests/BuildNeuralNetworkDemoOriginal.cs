...
#region data
            ...
            var nn = new OrigBuildNeuralNetwork(numInput, numHidden, numOutput);
...
//            TextWriter oldOut = Console.Out;
    ...
    public class OrigBuildNeuralNetwork
    {
        ...
        public OrigBuildNeuralNetwork(int numInput, int numHidden, int numOutput)
        {
